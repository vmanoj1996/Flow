 ...
 *
 * Source file: /home/manoj/gits/Flow/src/lib/uavcan/dsdl/uavcan/protocol/param/Value.uavcan
 */
...
struct UAVCAN_EXPORT Value_
{
    ...
    typedef ::uavcan::IntegerSpec< ::uavcan::IntegerBitLen< 5 >::Result,
...
{
    return is(Value_<0>::Tag::empty) ? &empty : NULL;
}
...
{
    return is(Value_<0>::Tag::integer_value) ? &integer_value : NULL;
}
...
{
    return is(Value_<0>::Tag::real_value) ? &real_value : NULL;
}
...
{
    return is(Value_<0>::Tag::boolean_value) ? &boolean_value : NULL;
}
...
{
    return is(Value_<0>::Tag::string_value) ? &string_value : NULL;
}
