 ...
 *
 * Source file: /home/manoj/gits/Flow/src/lib/uavcan/dsdl/uavcan/protocol/param/NumericValue.uavcan
 */
...
struct UAVCAN_EXPORT NumericValue_
{
    ...
    typedef ::uavcan::IntegerSpec< ::uavcan::IntegerBitLen< 3 >::Result,
...
{
    return is(NumericValue_<0>::Tag::empty) ? &empty : NULL;
}
...
{
    return is(NumericValue_<0>::Tag::integer_value) ? &integer_value : NULL;
}
...
{
    return is(NumericValue_<0>::Tag::real_value) ? &real_value : NULL;
}
